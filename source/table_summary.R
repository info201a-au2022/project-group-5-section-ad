...
# Data
crimes_against_person <- read.csv(file = "/Users/rinle/Documents/info201/Project/project-group-5-section-ad/data/Crimes_Against_Persons_by_State_2021.csv")
crimes_against_property <- read.csv(file = "/Users/rinle/Documents/info201/Project/project-group-5-section-ad/data/Crimes_Against_Property_by_State_2021.csv")
crimes_against_society <- read.csv(file = "/Users/rinle/Documents/info201/Project/project-group-5-section-ad/data/Crimes_Against_Society_by_State_2021.csv")
