...
crimes_against_persons <- read.csv(file = "~/Documents/info201/Project/project-group-5-section-ad/data/Crimes_Against_Persons_by_State_2021.csv")
...
game_data <- read.csv(file = "~/Documents/info201/Project/project-group-5-section-ad/data/game_Data.csv")
